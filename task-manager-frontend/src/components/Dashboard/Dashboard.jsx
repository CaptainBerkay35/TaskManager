...
function Dashboard() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* ✅ Özet Kartları - Mobilde 2 sütun, tablet'te 2, desktop'ta 4 */}
      ...
      {/* ✅ İlerleme, Kategori, Takvim - Mobilde stack, desktop'ta 3 sütun */}
      ...
      {/* ✅ Deadline Alerts - Mobilde stack, desktop'ta 2 sütun */}
